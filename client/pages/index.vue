<template>
    <div class="flex h-screen">
        <div class="m-auto bg-[#132D46] shadow-xl shadow-[#01C38D] rounded-xl">

            <!--            Display error starts-->
            <p v-if="displayError" class="text-red-500 text-sm text-center m-6 tracking-wider">
                Invalid email or password
            </p>
            <!--            Display error ends-->

            <!--            Form starts-->
            <form class="w-72 m-7" @submit.prevent="handleSubmit">
